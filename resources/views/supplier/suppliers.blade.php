...
@section('content')
    <div class="table-responsive text-nowrap">
        ...
        {{-- NEW SUPPLIER MODAL --}}
        <div class="modal fade" id="newSupplier" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="d-flex flex-column gap-3">
                                ...
                                <div class="fv-plugins-icon-container">
                                    <div class="form-floating form-floating-outline">
                                        <input value="{{ old('sname') }}" autocomplete="off" type="text" name="sname"
                                ...
                                <div class="fv-plugins-icon-container">
                                    <div class="form-floating form-floating-outline">
                                        <input value="{{ old('phone') }}" autocomplete="off" type="text" name="phone"
                                ...
                                <div class="fv-plugins-icon-container">
                                    <div class="form-floating form-floating-outline">
                                        <input value="{{ old('address') }}" autocomplete="off" type="text" name="address"
                                ...
                                <div class="fv-plugins-icon-container">
                                    <div class="form-floating form-floating-outline">
                                        <select name="status" class="form-control">
                                            <option value="1" class="form-control" placeholder="Status">Active</option>
                                            <option value="0" class="form-control" placeholder="Status">Inactive
                                            </option>
                                        </select>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="modal fade" id="deleteConfirmSupplier-{{ $supplier->id }}">
                                <div class="modal-dialog">
                                    <form action="{{ route('supplier.destroy', encrypt($supplier->id)) }}" method="post">

                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">DELETE SUPPLIER (<span
                                                        class="text-primary">{{ $supplier->sname }}</span>) </h5>
                            ...
                            <div class="modal fade" id="editSupplier-{{ $supplier->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <form action="{{ route('supplier.update', encrypt($supplier->id)) }}" method="post">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">EDIT SUPPLIER (<span
                                                        class="text-primary">{{ $supplier->sname }}</span>) </h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                ...
                                                <div class="d-flex flex-column gap-3">
                                                    ...
                                                    <div class="fv-plugins-icon-container">
                                                        <div class="form-floating form-floating-outline">
                                                            <input value="{{ $supplier->sname }}" autocomplete="off"
                                                    ...
                                                    <div class="fv-plugins-icon-container">
                                                        <div class="form-floating form-floating-outline">
                                                            <input value="{{ $supplier->phone }}" autocomplete="off"
                                                    ...
                                                    <div class="fv-plugins-icon-container">
                                                        <div class="form-floating form-floating-outline">
                                                            <input value="{{ $supplier->address }}" autocomplete="off"
