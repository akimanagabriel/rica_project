                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-3">
                                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#editSubject-{{ $course->id }}">
                                ...
                                <div class="modal fade" id="editSubject-{{ $course->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <form action="{{ route('subject.update', encrypt($course->id)) }}" method="post">
                                            @csrf
                                            @method('put')
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">SUBJECT INFORMATION UPDATE</h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="d-flex flex-column gap-3">
                                                        ...
                                                        <div class="fv-plugins-icon-container">
                                                            <div class="form-floating form-floating-outline">
                                                                <input value="{{ $course->cousename }}" autocomplete="off"
                                                                    type="text" name="cousename" class="form-control"
                                                        ...
                                                        <div class="fv-plugins-icon-container">
                                                            <div class="form-floating form-floating-outline">
                                                                <input value="{{ $course->shortname }}" autocomplete="off"
                                                                    type="text" name="shortname" class="form-control"
