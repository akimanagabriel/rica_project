                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" id="editStudent-{{ $student->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <form action="{{ route('student.update', encrypt($student->id)) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('put')
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4 fv-plugins-icon-container">
                                                                    <div class="form-floating form-floating-outline">
                                                                        <input value="{{ $student->cdate }}"
                                                                            autocomplete="off" type="date"
                                                                            id="formValidationName" name="dob"
                                                                            class="form-control" placeholder="John Doe">
                                                                        <label for="formValidationName">Date Of
                                                                            Birth</label>
                                                                    </div>
                                                                    <div
                                                                        class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                                                ...
                                                                <div class="col-md-2 fv-plugins-icon-container">
                                                                    <div class="form-floating form-floating-outline mb-2">
                                                                        ...
                                                                        <label for="formValidationName">Academic
                                                                            year</label>
                                                                    </div>
                                                                    <div
                                                                        class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
