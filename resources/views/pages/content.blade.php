<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row gy-4">
            ...
            <div class="card h-100">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="dropdown">
                            <button class="btn p-0" type="button" id="totalSalesDropdown"
                                data-bs-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <i class="mdi mdi-dots-vertical mdi-24px"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-end"
                                aria-labelledby="totalSalesDropdown">
            ...
            <div class="card h-100">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="dropdown">
                            <button class="btn p-0" type="button" id="revenueReportDropdown"
                                data-bs-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <i class="mdi mdi-dots-vertical mdi-24px"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-end"
                                aria-labelledby="revenueReportDropdown">
                                <a class="dropdown-item" href="javascript:void(0);">Last 28
                                    Days</a>
                                <a class="dropdown-item" href="javascript:void(0);">Last Month</a>
                                <a class="dropdown-item" href="javascript:void(0);">Last Year</a>
            ...
            <div class="card h-100">
                <div class="card-header pb-1">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="dropdown">
                            <button class="btn p-0" type="button" id="salesOverviewDropdown"
                                data-bs-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <i class="mdi mdi-dots-vertical mdi-24px"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-end"
                                aria-labelledby="salesOverviewDropdown">
                                <a class="dropdown-item" href="javascript:void(0);">Last 28
                                    Days</a>
                                <a class="dropdown-item" href="javascript:void(0);">Last Month</a>
                                <a class="dropdown-item" href="javascript:void(0);">Last Year</a>
                                ...
                                <div class="d-flex">
                                    <a href="javascript:void(0)" class="me-3">
                                        <img src="../../assets/img/icons/misc/pdf.png"
                                            alt="PDF image" width="20" class="me-1" />
        ...
        <div class="col-xl-4 col-lg-8 col-md-6">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <div class="dropdown">
                        <button class="btn p-0" type="button" id="upgradePlanCard"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="mdi mdi-dots-vertical mdi-24px"></i>
                        </button>
                        <div class="dropdown-menu dropdown-menu-end"
                            aria-labelledby="upgradePlanCard">
                ...
                <div class="card-body pt-0">
                    <small>Please make the payment to start enjoying all the features of our premium
                        plan as soon as
                        possible.</small>
                            ...
                            <div
                                ...
                                <div class="user-progress">
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <sub class="mt-auto mb-2 pb-1 text-heading small">
                                            /Year</sub>
                                    </div>
                                </div>
                            </div>
                    ...
                    <form id="paymentDetailsForm" onsubmit="return false">
                        ...
                        <div class="d-flex mb-3">
                            <div class="me-3">
                                <img src="../../assets/img/icons/payments/logo-mastercard-small.png"
                            ...
                            <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                                ...
                                <div class="w-px-75">
                                    <input type="text" class="form-control cvv-code-payment"
                        ...
                        <div class="d-flex mb-3">
                            <div class="me-3">
                                <img src="../../assets/img/icons/payments/logo-credit-card-2.png"
                                    alt="credit card" height="30" />
                            </div>
                            <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                                <div>
                        ...
                        <a href="javascript:;" class="d-block mt-2 mb-3 pb-1 small"
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card">
                <img class="card-img-top" src="../../assets/img/elements/laptop.png"
                    alt="laptop image cap" height="188" style="object-fit: cover" />
                <div class="card-body">
                    <div class="d-flex border-bottom pb-3">
                        <div
                            class="badge bg-label-primary d-flex flex-column justify-content-center px-3 rounded-3 me-3">
                            <h6 class="text-primary mb-2 fw-normal">Jan</h6>
                            <h5 class="text-primary mb-0">24</h5>
                        </div>
                        <div class="w-75">
                            <h6 class="card-title mb-1">Developer Meetup</h6>
                            <small class="mb-0">The WordPress open source,free software project
                                is the community behind the…</small>
                        </div>
                    </div>
                ...
                <div class="modal-body pb-md-0 px-0">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div class="d-flex justify-content-center me-2 mt-3">
                            <sup
                                class="h5 pricing-currency pt-1 mt-2 mb-0 me-1 text-primary">$</sup>
                            <h1 class="display-3 mb-0 text-primary">99</h1>
                            <sub
                                class="h6 pricing-duration mt-auto mb-2 pb-1 text-body">/month</sub>
                        </div>
                        <button class="btn btn-outline-danger cancel-subscription mt-3">Cancel
                            Subscription</button>
                    </div>
                </div>
            </div>
